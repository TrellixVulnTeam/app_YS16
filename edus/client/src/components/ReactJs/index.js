...
const components = {
  MainCompo, AsyncAwait, IntroRectJs, ContextMeth, NumberForm, DropdownSelect, HackeRank, PureComp, TextEditors,
  Models, ContextHooks, UseStates, UseReducers, Like, CustomHooks, SSRendering, JsonPlaceholder, TicGame, LinkGet
};
