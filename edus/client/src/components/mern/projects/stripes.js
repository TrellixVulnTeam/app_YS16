...
const AppComp = `
//.env
REACT_APP_KEY=pk_test_51He1P4Jz7nbfLVoYE9377AbN7XiJcg9JeXrfu1qap2894g8T6hfrNgnMceZRtx1H9n0HxIyHLqyv4lZvqxv3ifMf004hVnMdtT
  ...
  return (
    <div className="App">
     ...
     <StripeCheckout 
      ...
      stripeKey="pk_test_51He1P4Jz7nbfLVoYE9377AbN7XiJcg9JeXrfu1qap2894g8T6hfrNgnMceZRtx1H9n0HxIyHLqyv4lZvqxv3ifMf00
                 4hVnMdtT"
      token={makePayment}
      amount={product.price * 100}
      name="Reactjs"
        ...
        <FacebookLogin
          ...
          render={renderProps => (
            <button className="btn btn-primary" onClick={renderProps.onClick} 
             disabled={this.props.dashboard.methods.includes('facebook') ? true : false}>Link with Facebook</button>
          )}
          fields="name,email,picture"
