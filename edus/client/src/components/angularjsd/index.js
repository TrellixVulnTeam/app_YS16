...
const AungularEvents = lazy(() => import('./deepAngularjs/angularEvents'));
...
const components = {
  ...
  Directives, AungularEvents, Fiters, AngularForm, Logic3, AngularDir2, MetaData, NgrxCurd, NgrxCounter,
  Scope, Services12, Validations, Filterss, AngularCurd12, AngularFor,
  Projection12, FilterPlace, MultiCheck, RadioButton12, Services, Vote,
  DropDownAngular, AngularSelector,
