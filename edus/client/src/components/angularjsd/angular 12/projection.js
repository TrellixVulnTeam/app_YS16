        ...
        <Grid item xs={10}>
          <Paper className={classes.paper}>
            <List>
              ...
              <ul>
                <li>Import Output and EventEmitter in the child component.</li>
                <li>parentFun @Output() has a type of EventEmitter, which means it's an event.</li>
                <li>Create sendData() method in the same component class.</li>
              </ul>
              The child's template has controls on 'button' with a click event binding.
              <br />
              The (click) event is bound to the sendData() method in the child component class. The sendData() method takes as its
              argument the value of the click property.
              <div style={titles}>
                <PrismCode
                  code={childParent}
                  language="js"
