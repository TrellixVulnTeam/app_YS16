        ...
        <Grid item xs={10}>
          <Paper className={classes.paper}>
            <List>
              ...
              <br />
              <b>Ex. </b>Let us take a pipe to transform a component's birthday property into a human-friendly date using date pipe.
              <br />
              <div style={titles}>
                <PrismCode
                  code={pipeFor}
              ...
              <ul>
                ...
                <b>Impure pipes:</b>
                <br />
                <li>Angular executes an impure pipe during every component change detection cycle. An impure pipe is called often, as often as every keystroke or mouse-move.</li>
              </ul>
              <br />
