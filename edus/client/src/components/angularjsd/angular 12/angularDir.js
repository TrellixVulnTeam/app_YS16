          ...
          <Paper className={classes.paper}>
            <List>
              ...
              <ul>
                ...
                <li>The Angular Elements package allows you to create native custom elements and author web components with Angular.</li>
                <li>The @angular/elements package provides a createCustomElement() API that can be used to transform Angular Components to native Custom Elements.</li>
                ...
                <li>Angular elements are Angular components packaged as custom elements (also called Web Components), a web standard for defining new HTML elements in a framework-agnostic way.</li>
