...
<body>
<p><button onclick="clickCounter()" type="button">Counter</button></p>
<div id="result"></div>
</body>
`.trim();
...
const clickCounter = () => {
  if (typeof (Storage) !== "undefined") {
    ...
    document.getElementById("result").innerHTML = "Clicked the button " + sessionStorage.clickcount + " time(s)";
  } else {
    document.getElementById("result").innerHTML = "Browser does not support web storage...";
  }
}`.trim();
        ...
        <Grid item xs={10}>
          <Paper className={classes.paper}>
            <List>
              ...
              <h3>30. HTML Web Storage Objects:</h3>
              ...
              <h3>31. The localStorage Object</h3>
