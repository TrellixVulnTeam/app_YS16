...
const { ReduxState, ReduxMethods, Git, Skills, IntroRedux, ReactRedux, ContctHooks, ExpenseTraMern, GitConcepts,
  CountersRedux, MernRedux, ReduxCurd, SignUp } = ReduxMains;

const { Arrays, Clousers, FindOutput, JsObject, Logic, Methods,
  IntroJs, Prototypes, ArraysApi, Oops, Reduce,
  KeyedCollections, RegularExp, HackerRank1, HackerRank6 } = JsMains;

const { NodeJsCodes, ServerSide, IntroNodeJs, Tur1, Tut2, Tut6, Udemy, Ejs,
  SignUps, BufferNode, Token, ChildsPros,
  EvtNode, FileSys } = NodeMains;

const { GridFs, Intro, MongodbMethods, IntroMD, CurdOp, BulkWright, MysqlCurd, MongoCurd, Mysql, PostgresSQL
} = MongodbMains;
...
const { Graph, LinkedList, Queue, Stack, Sort, Search, IntroAlgo, Heap, TopTech } = AlMains;
    ...
    <section className="container">
      ...
      <Switch>
        <Suspense fallback={<div>Loading Page...</div>}>
          ...
          <Route exact path="/angularEvents" component={AungularEvents} />
